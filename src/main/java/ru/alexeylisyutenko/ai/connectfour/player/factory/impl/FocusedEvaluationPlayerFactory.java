...
public class FocusedEvaluationPlayerFactory extends AbstractPlayerFactory {
    @Override
    public String getImplementationName() {
        return "Focused evaluation player";
    }
    ...
    public Player create(Integer depth, Integer timeout, Map<String, ?> additionalArguments) {
        ...
        return new MinimaxBasedPlayer(new TranspositionTableAlphaBetaSearchFunction(), new CachingEvaluationFunction(new FocusedEvaluationFunction()), depth);
    }
}
