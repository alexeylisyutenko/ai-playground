...
import ru.alexeylisyutenko.ai.connectfour.minimax.search.iterativedeepening.stoppablesearch.StoppableSearch;
...
public class IterativeDeepeningSearchFunction implements SearchFunction {
    ...
    private final StoppableSearch stoppableSearch;
    private Move bestMove;

    public IterativeDeepeningSearchFunction(int timeout) {
        this.timeout = timeout;
        this.stoppableSearch = new DefaultStoppableSearch();
    }
